...
<div class="wrap">
  ...
  <nav class="navTiles" id="navTiles">
    ...
    <button class="tile" data-tab="license"><span class="ico">🔐</span>Lisensi</button>
...
(function(){
  ...
  document.querySelectorAll('.tile[data-tab]').forEach(function(btn){btn.onclick=function(){switchTab(btn.dataset.tab);};});
