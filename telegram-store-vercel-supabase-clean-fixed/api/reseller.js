...
(function(){
  ...
  function renderUsers(sortMode){
    ...
    document.getElementById('userList').innerHTML=rows.map(function(u){
      ...
      return '<article class="userCard"><div class="userIdentity"><div class="userAvatar">'+esc(initial)+'</div><div class="userMain"><b>'+display+'</b><small>ID '+esc(u.telegram_id)+'</small></div></div><div class="userMetric userTransactions"><span>Transaksi</span><b>'+esc(u.transaction_count||0)+'</b></div><div class="userMetric userSpending"><span>Spending</span><b>'+rupiah(u.spending||0)+'</b></div><button class="btn red userDelete" data-del-user="'+esc(u.telegram_id)+'">Hapus</button></article>';
