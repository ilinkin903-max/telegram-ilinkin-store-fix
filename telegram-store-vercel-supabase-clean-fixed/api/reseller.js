  ...
  <section id="supplierSettings" class="section">
    ...
    <div class="panel">
      ...
      <form id="telegramSupplierProductForm" class="form">
        ...
        <div class="field"><label class="label">Flow Order (JSON)</label><textarea class="textarea tall" name="order_flow" required placeholder='[{"type":"start"},{"type":"click","text":"Order"},{"type":"click","text":"Zoom"},{"type":"send","text":"{{quantity}}"},{"type":"click","text":"Konfirmasi","commit":true},{"type":"wait","contains":"berhasil","capture_delivery":true,"timeout_ms":60000}]'></textarea></div>
