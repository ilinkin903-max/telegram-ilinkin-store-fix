  ...
  <section id="workflowSettings" class="section">
    ...
    <div class="panel" id="workflowRecorderPanel">
      ...
      <div class="workflowRecorder">
        <div>
          <div class="workflowMessage"><b>Pesan bot supplier yang diterima</b><p class="help">Jika supplier mengirim 2 pesan atau lebih, pilih <b>pesan yang benar-benar dipakai</b>. Setelah pesan dipilih, Anda dapat <b>blok/select hanya bagian teks produk</b> atau <b>angka stok</b> pada kotak pesan. Tombol supplier tetap dapat dipilih langsung.</p><div id="workflowLastMessage"><div class="empty">Belum ada balasan. Pilih kategori teks lalu kirim /start atau perintah lain.</div></div></div>
