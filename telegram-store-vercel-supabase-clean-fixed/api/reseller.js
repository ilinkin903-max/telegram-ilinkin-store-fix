  ...
  <section id="supplierSettings" class="section">
    ...
    <div class="panel">
      ...
      <form id="supplierAiConfigForm" class="form">
        ...
        <div class="row2"><div class="field"><label class="label">Provider</label><input class="input" value="Google Gemini" readonly><p class="help">Base URL otomatis: generativelanguage.googleapis.com/v1beta/openai</p></div><div class="field"><label class="label">Model Gemini</label><input class="input" name="model" list="geminiModelList" placeholder="gemini-2.5-flash"><datalist id="geminiModelList"><option value="gemini-2.5-flash"><option value="gemini-2.5-flash-lite"><option value="gemini-3.6-flash"></datalist><p class="help">Disarankan <b>gemini-2.5-flash</b> untuk membuat flow dan regex.</p></div></div>
        ...
        <div class="buttonRow"><button class="btn lime" type="submit">Simpan Gemini</button><button class="btn cyan" id="testSupplierAi" type="button">Tes Koneksi Gemini</button><a class="btn yellow" href="https://aistudio.google.com/apikey" target="_blank" rel="noopener">Buat API Key Google</a></div>
      </form>
    </div>
    <div class="panel">
...
(function(){
  ...
  async function loadSupplier(force){
    ...
    state.supplierAi=await apiSafe('supplier-ai-config',{configured:false,base_url:'https://generativelanguage.googleapis.com/v1beta/openai',model:'gemini-2.5-flash',backend:'chat_completions'});
    renderSupplierAi();
  ...
  var testSupplierAi=document.getElementById('testSupplierAi'); if(testSupplierAi) testSupplierAi.onclick=async function(){testSupplierAi.disabled=true;var old=testSupplierAi.textContent;testSupplierAi.textContent='Mengetes Gemini...';try{var r=await api('supplier-ai-test',{});toast((r.data&&r.data.ok?'AI terhubung: ':'AI merespons: ')+String((r.data&&r.data.response)||'OK'));state.supplierAi=await apiSafe('supplier-ai-config',state.supplierAi||{});renderSupplierAi();}catch(err){toast(err.message,true);}finally{testSupplierAi.disabled=false;testSupplierAi.textContent=old;}};
