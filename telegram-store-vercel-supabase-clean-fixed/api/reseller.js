...
@media(max-width:620px){.chart{height:330px;grid-template-columns:repeat(7,minmax(64px,1fr));gap:6px;padding:10px 8px 14px}.bar{width:min(34px,72%)}.barLabel{font-size:10px;max-width:66px}}
</style>
</head>
<body>
<div class="wrap">
