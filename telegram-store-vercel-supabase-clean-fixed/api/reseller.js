...
(function(){
  ...
  async function load(){
    try{
      ...
      renderHeader(); renderLicense(); renderStats(); renderCharts(); renderProducts(); renderOrders(); renderUsers(); renderVouchers(); renderPolls(); renderMaintenance(); renderBackup(); renderPromos(); renderDeepStats();
