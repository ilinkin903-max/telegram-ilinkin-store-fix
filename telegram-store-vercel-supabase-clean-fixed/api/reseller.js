  ...
  <section id="supplierSettings" class="section">
    ...
    <div class="panel">
      ...
      <form id="telegramSupplierProductForm" class="form">
        ...
        <div class="field"><label class="label">Flow Cek Stok (JSON, opsional)</label><textarea class="textarea tall" name="stock_flow" placeholder='[{"type":"start"},{"type":"click","text":"Produk"},{"type":"click","text":"Zoom"},{"type":"capture"}]'></textarea><p class="help">Flow ini dijalankan on-demand ketika user membuka produk/varian. Kosongkan jika bot supplier tidak menampilkan stok.</p></div>
