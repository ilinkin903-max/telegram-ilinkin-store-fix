...
if (!apiId || !apiHash) {
  console.error('Isi TG_API_ID dan TG_API_HASH di file .env project terlebih dahulu.');
  process.exit(1);
}
...
(async () => {
  ...
  console.log('\nLOGIN BERHASIL. Simpan string berikut sebagai TG_STRING_SESSION di Vercel Environment Variables.');
